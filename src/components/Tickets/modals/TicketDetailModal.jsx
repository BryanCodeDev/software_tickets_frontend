                ...
                <div className="space-y-2">
                  {canEditTicket(selectedTicket) && (
                    <button
                      ...
                      className="w-full px-3 lg:px-4 py-2 lg:py-3 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-xl transition-all flex items-center gap-2 text-sm lg:text-base"
                    >
                  ...
                  {canDeleteTicket(selectedTicket) && (
                    <button
                      ...
                      className="w-full px-3 lg:px-4 py-2 lg:py-3 bg-red-50 hover:bg-red-100 text-red-700 font-semibold rounded-xl transition-all flex items-center gap-2 text-sm lg:text-base"
                    >
                  ...
                  <button
                    onClick={() => setShowDetailModal(false)}
                    className="w-full px-3 lg:px-4 py-2 lg:py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-all flex items-center gap-2 text-sm lg:text-base"
                  >
