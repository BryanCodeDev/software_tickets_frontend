...
const TicketStats = ({ stats }) => {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 lg:gap-4 mb-6 animate-fade-in">
      <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg">
      ...
      <div className="bg-gradient-to-br from-[#662d91] to-[#8e4dbf] rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
      ...
      <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
      ...
      <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
      ...
      <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
          <FaExclamationTriangle className="w-6 h-6 lg:w-8 lg:h-8 opacity-80" />
      ...
      <div className="bg-gradient-to-br from-[#8e4dbf] to-[#8e4dbf] rounded-xl lg:rounded-2xl p-3 lg:p-5 text-white shadow-lg col-span-2 sm:col-span-3 lg:col-span-1 xl:col-span-1">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
