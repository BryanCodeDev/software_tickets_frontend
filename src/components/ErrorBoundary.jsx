...
const ErrorBoundaryUI = ({ handleReload, handleReset, error, errorInfo }) => {
  ...
  return (
    <div className={conditionalClasses({
      light: "min-h-screen bg-gradient-to-br from-[#f3ebf9] via-[#e8d5f5] to-[#dbeafe] flex items-center justify-center p-4",
      dark: "min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4"
    })}>
      <div className={conditionalClasses({
        ...
        <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 lg:px-6 py-3 bg-gradient-to-r from-[#662d91] to-[#8e4dbf] hover:from-[#7a3da8] hover:to-violet-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
          >
