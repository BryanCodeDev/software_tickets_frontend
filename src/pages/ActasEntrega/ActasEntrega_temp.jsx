...
const ActasEntrega = () => {
  ...
  if (loading) return (
    <div className={conditionalClasses({
      light: 'min-h-screen bg-gradient-to-br from-[#f3ebf9] via-[#e8d5f5] to-[#dbeafe] py-8 px-4',
  ...
  return (
    <div className={conditionalClasses({
      light: 'min-h-screen bg-gradient-to-br from-[#f3ebf9] via-[#e8d5f5] to-[#dbeafe] py-4 px-3 sm:py-6 sm:px-4 lg:px-8',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {filteredActas.length === 0 ? (
          <div className={conditionalClasses({
            ...
            <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-[#f3ebf9] to-[#dbeafe] rounded-full flex items-center justify-center mx-auto mb-4">
