...
const PurchaseRequests = () => {
  ...
  const PurchasesPanel = () => {
   ...
   if (loading) {
     return (
       <div className={conditionalClasses({ light: 'min-h-screen flex items-center justify-center', dark: 'min-h-screen flex items-center justify-center' })}>
   ...
   return (
     <div className={conditionalClasses({
       light: 'min-h-screen py-2 px-2 sm:py-4 sm:px-3 lg:py-6 lg:px-8',
       dark: 'min-h-screen py-2 px-2 sm:py-4 sm:px-3 lg:py-6 lg:px-8'
     })}>
